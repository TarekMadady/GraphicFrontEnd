  ...
  return ( <
    > {
      showPanel ? ( <
        ...
        /strong> <
        br / >
        يهدف هذا الإختبار إلى قياس الجوانب المعرفية لمهارات انتاج الرسومات المتحركة ثنائية وثلاثية الأبعاد لدى طلاب كلية التربية. < br / >
        <
        strong className = "text-primary h1 fw-bold" >
        تعليمات الإختبار:
        <
        ...
        <
        li >
        يحتوى هذا الإختبار على جزئين؛ جزء خاص بأسئلة الإختيار من متعدد، وجزء خاص لأسئلة الصواب والخطأ. <
        /li> <
